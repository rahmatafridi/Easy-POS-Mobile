$(document).ready(function () {
    ...
    if (fDate != "" && tDate != "" && fDate != "null" && tDate != "null") {
        LoadCustomerTransactionDetailWithDate();
    }
    else {
        LoadCustomerTransactionDetail();
    }

});


var LoadCustomerDetail = function () {
    ...
    $.ajax({
        type: "POST",
        cache: false,
        url: "../Reports/CustomerDetail?UID=" + uid,
        data: data,
        processData: false,
        contentType: false,
...
var LoadCustomerTransactionDetailWithDate = function () {
    var uid = getParameterByName('UID');
    var fDate = getParameterByName('fDate');
    var tDate = getParameterByName('tDate');
    ...
    $.ajax({
        type: "POST",
        cache: false,
        url: "../Reports/CustomerTransactionDetailWithDate?UID=" + uid+"&fDate="+fDate+"&tDate="+tDate,
        processData: false,
        contentType: false,
...
var LoadCustomerTransactionDetail = function () {
    var uid = getParameterByName('UID');
    $.ajax({
        type: "POST",
        cache: false,
        url: "../Reports/CustomerTransactionDetail?UID=" + uid,
        processData: false,
        contentType: false,
        success: function (data) {
            data = JSON.parse(data);
