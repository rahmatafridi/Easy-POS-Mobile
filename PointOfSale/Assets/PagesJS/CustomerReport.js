...
$(document).on('click', '.btn-detail', function () {
    ...
    window.location = ('../Reports/CustomerDetailView?UID=' + uid+"&fDate=null&tDate=null");
...
$(document).on('click', '.btn-detailDate', function () {
    ...
    var fDate = $('#fDate').val();
    var tDate = $('#tDate').val();
    window.location = ('../Reports/CustomerDetailView?UID=' + uid+"&fDate="+fDate+"&tDate="+tDate);
...
LoadGridData = function () {
    $.ajax({
        type: "POST",
        cache: false,
        url: "../Reports/CustomerLoadGrid",
        processData: false,
        contentType: false,
        success: function (data) {
            data = JSON.parse(data);
            $('#tblCustomerReport').DataTable().destroy();
            var html = '';
            ...
            $("#tbody").append(html);
            $('#tblCustomerReport').DataTable().draw();
        }
    });
}
