<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleReturnInvoice.aspx.cs" Inherits="PointOfSale.ASPXPages.SaleReturnInvoice" %>
        ...
        <div>
            ...
            <div class="ticketprint">
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            <center><b><span style="margin-top: 20px; font-size: 15px;">Stock Return Invoice</span></b></center>
                        </td>
                    </tr>
