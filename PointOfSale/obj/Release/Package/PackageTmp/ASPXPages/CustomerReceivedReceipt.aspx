<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerReceivedReceipt.aspx.cs" Inherits="PointOfSale.ASPXPages.CustomerReceivedReceipt" %>
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td align="center" style="font-size: 20px;">
                            <u>Customer Recieving Receipt</u>
                        </td>
                    </tr>
                    <tr id="trCustomer" runat="server">
                        <td align="left" style="font-size: 15px; font-weight: bold; padding-left: 9px;">Customer: <span id="spnCustomer" runat="server" style="font-family:Arial"></span>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td class="format" style="width: 100%; border-left: 1px solid black; border-bottom: 1px solid black; padding: 1%; border-right: 1px solid black;" align="left">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="format" style="width: 60%; padding: 1%; text-align: left;  font-size: 12px;">Received Amount
                                    </td>
