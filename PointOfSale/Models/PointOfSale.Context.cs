...
namespace PointOfSale.Models
{
    ...
    public partial class PointOfSaleEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetStockInHandReport_Result> GetStockInHandReport(Nullable<int> catId, Nullable<int> subCatId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetStockInHandReport_Result>("GetStockInHandReport", catIdParameter, subCatIdParameter);
        }
        ...
        public virtual ObjectResult<GetStockInHandReportSummary_Result> GetStockInHandReportSummary(Nullable<int> catId, Nullable<int> subCatId)
        {
            var catIdParameter = catId.HasValue ?
                new ObjectParameter("CatId", catId) :
                new ObjectParameter("CatId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetStockInHandReportSummary_Result>("GetStockInHandReportSummary", catIdParameter, subCatIdParameter);
        }
        ...
        public virtual ObjectResult<GetItemByUID_Result> GetItemByUID(Nullable<System.Guid> uID)
        {
            var uIDParameter = uID.HasValue ?
                new ObjectParameter("UID", uID) :
                new ObjectParameter("UID", typeof(System.Guid));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetItemByUID_Result>("GetItemByUID", uIDParameter);
        }
    }
}
